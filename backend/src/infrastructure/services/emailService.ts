                      ...
                      <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 20px;font-size:16px;font-weight:bold;color:#1a1a1a;">${name}</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
                              <tr>
                                <td style="background-color:#f7f5f0;border-radius:8px;border:1px solid #d8d4cc;padding:14px 16px;">
                                  ...
                                  <p style="margin:0;font-size:12px;color:#4ecba4;word-break:break-all;font-family:Courier New,monospace;">${resetUrl}</p>
                                </td>
                              </tr>
                            </table>
