import { validateNumberField, validateStringField, validateDateField } from "../../../domain/utils/validation.utils";
...
export class ListCourseDTO {
  ...
  static create(value: unknown): ListCourseDTO {
    ...
    if (raw.nameOrAcronym !== undefined) {
      filters.nameOrAcronym = validateStringField(raw.nameOrAcronym, "nameOrAcronym");
    }
    if (raw.startDate) {
